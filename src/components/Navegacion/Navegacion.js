        ...
        <Header className={"a1 " + classes.background}>
          <div className="menuCon a2">
            <div className="top-menu row a3">
              ...
              <div className="col-md-5 row a4 containe-categorias d-flex justify-content-end">
                <Menu
                  className={
                    "float-right navbar-menu-sesion a50 " + classes.background
                  }
                  /* theme="light" */
                  mode="horizontal"
                ...
                >
                  ...
                  <Menu.Item
                    className={
                      "nav-font-color nav-border-color font-nav a6 " +
                      classes.hover
                    }
                    key="/"
                  >
                  ...
                  {token && decoded["rol"] === false ? (
                    ...
                    >
                      {!decoded || decoded.rol === true ? (
                        ...
                        <Menu.Item
                          className="nav-font-color-sesion a6 font-nav"
                          key="/pedidos"
                        >
                          <ShoppingOutlined />
                          Mis compras
                      ...
                      <Menu.Item
                        key=""
                        className="nav-font-color-sesion font-nav"
                      >
                        <SettingOutlined />
                        Mi cuenta
                        <Link to="/perfiles" />
                  ...
                  {token === "" || token === null ? (
                    <Menu.Item
                      key=""
                      className="nav-font-color-sesion nav-border-color a6"
                    >
                      <div className="centrar-nav">
        ...
        <Header className={"a1 " + classes.background}>
          <div className="d-flex justify-content-center">
            ...
            >
              ...
              <Menu.Item
                className={
                  "nav-font-color nav-border-color font-nav a6 " + classes.hover
                }
                key="/productos"
              >
                <div className="centrar-nav">Productos</div>
            ...
            <div className="row">
              <div className="col-10 mb-1 ml-2 mt-1">
                <Search
                  ...
                  onSearch={(value) =>
                    props.history.push(`/searching/${value}`)
                  }
                />
              </div>
              ...
              <div className="top-menu row a3 ">
                <div className="col-lg-12 a4 containe-categorias">
                  <div className="row input-search d-flex justify-content-center">
                    ...
                    <Button
                      onClick={(value) =>
                        props.history.push(`/searching/${busqueda}`)
                      }
